...
tableOutput("summary_stats_region"),
tableOutput("summary_stats_segment"),
...
server <- function(input, output, session) {
 ...
 subset_data <- eventReactive(input$subset_btn, {
  ...
  # Filter by first numeric variable
  ...
  # Filter by second numeric variable
...
output$explore_controls <- renderUI({
  ...
  if ("table" %in% input$explore_options) {
    if (input$summary_type == "cat") {
      ...
      ui_list <- append(ui_list, list(
        checkboxGroupInput("table_type_num", "Select what variables you want to see numeric summaries for:",
